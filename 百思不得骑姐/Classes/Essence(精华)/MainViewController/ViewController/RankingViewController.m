...
- (void)loadData
{
    ...
    [manager GET:EssenceRankingUrl parameters:nil success:^(AFHTTPRequestOperation *operation, NSDictionary *responseObject) {
...
- (void)setUpMoreData
{
    ...
    __weak UITableView *tableV = self.tableViewAll;
        MJRefreshAutoNormalFooter *footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
            ...
            NSString *str1 = [NSString stringWithFormat:@"204S&from=ios&jbk=0&mac=&market=&maxtime=%@&openudid=379ec5e20a2a6ca41a523ed24c985a847b0a580a&order=repost&page=%d&per=20&sub_flag=1&time=week&type=1&udid=&ver=3.6.1",self.maxTime,count];
...
//    NSString *identifier = [NSString stringWithFormat:@"%ld%ld",indexPath.section,indexPath.row];
    static NSString *identifier = @"ranking";
