...
- (void)setupPlusButton
{
    ...
    [plusButton setBackgroundImage:[UIImage imageNamed:@"tabBar_publish_icon"] forState:UIControlStateHighlighted];
    // 设置图标
//    [plusButton setImage:[UIImage imageNamed:@"iconfont-jia"] forState:UIControlStateNormal];
//    [plusButton setImage:[UIImage imageNamed:@"iconfont-jia"] forState:UIControlStateHighlighted];
